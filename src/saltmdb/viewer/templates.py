...
<aside class="sidebar"><h1>SALTMDB</h1><nav aria-label="Viewer">
...
</nav></aside><main id="main"><header><div><p class="eyebrow">Knowledge operations</p><h2 id="view-title">Overview</h2></div>
