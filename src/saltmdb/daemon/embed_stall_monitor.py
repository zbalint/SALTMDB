...
class EmbedStallMonitor:
    ...
    def _check_once(self) -> None:
        ...
        logger.warning(
            "embed-stall-monitor: %d entities stuck embedding_status='pending' past the %ds "
            "threshold; oldest=%s created_at=%s",
            stale_count,
    ...
    def _query_stale_pending(self) -> tuple[int, str | None, str | None]:
        """Return count and oldest active pending entity, without using ``_embed_pool``."""
