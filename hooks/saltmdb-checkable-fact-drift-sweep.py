...
DRIFT_SWEEP_PROMPT = (
    ...
    "title=<unchanged>, content=<unchanged>, tags=<unchanged>, owner_id='agent_hook_driftsweep', and "
    ...
    "5. Record: Store one summary memory via mcp__saltmdb__store_memory (owner_id='agent_hook_driftsweep', "
