...
class TestMedianAndEscalation(unittest.TestCase):
    def test_plain_median_no_escalation(self):
        ...
        raws = [
            _raw("claude", "q1", "c1", 1),
            _raw("cadet_gemini_flash", "q1", "c1", 1),
            _raw("codex", "q1", "c1", 2),
        ]
    ...
    def test_ground_truth_conflict_triggers_escalation(self):
        ...
        raws = [
            _raw("claude", "q1", "answer_entity", 1),
            _raw("cadet_gemini_flash", "q1", "answer_entity", 1),
            _raw("codex", "q1", "answer_entity", 0),
        ]
    ...
    def test_ground_truth_item_graded_2_is_not_escalated_for_that_reason(self):
        raws = [
            _raw("claude", "q1", "answer_entity", 2),
            _raw("cadet_gemini_flash", "q1", "answer_entity", 2),
            _raw("codex", "q1", "answer_entity", 2),
        ]
        result = mj.merge_query_judgments(raws, source_entity_ids=["answer_entity"])
        item = result[0]
    ...
    def test_both_triggers_can_fire_together(self):
        raws = [
            _raw("claude", "q1", "answer_entity", 0),
            _raw("cadet_gemini_flash", "q1", "answer_entity", 1),
            _raw("codex", "q1", "answer_entity", 2),
        ]
        result = mj.merge_query_judgments(raws, source_entity_ids=["answer_entity"])
    ...
    def test_multiple_candidates_grouped_independently(self):
        raws = [
            _raw("claude", "q1", "c1", 2),
            _raw("cadet_gemini_flash", "q1", "c1", 2),
            _raw("codex", "q1", "c1", 2),
            _raw("claude", "q1", "c2", 0),
            _raw("cadet_gemini_flash", "q1", "c2", 0),
            _raw("codex", "q1", "c2", 0),
        ]
        result = mj.merge_query_judgments(raws)
...
class TestCalibrationAccuracy(unittest.TestCase):
    def test_hand_computed(self):
        merged = [
            mj.MergedJudgment(
                "q1",
                "answer1",
                {"claude": 2, "cadet_gemini_flash": 2, "codex": 2},
                median_grade=2,
                escalated=False,
            ),
            mj.MergedJudgment(
                "q2",
                "answer2",
                {"claude": 1, "cadet_gemini_flash": 1, "codex": 1},
                median_grade=1,
                escalated=False,
            ),
            mj.MergedJudgment(
                "q1",
                "distractor",
                {"claude": 0, "cadet_gemini_flash": 0, "codex": 0},
                median_grade=0,
                escalated=False,
            ),
        ]
    ...
    def test_uses_final_grade_including_arbitration(self):
        item = mj.MergedJudgment(
            "q1",
            "answer1",
            {"claude": 0, "cadet_gemini_flash": 1, "codex": 2},
            median_grade=1,
            escalated=True,
        )
        mj.apply_arbitration_override(item, arbitrated_grade=2)
